import { mainPage, transitionTime, page1LOAD, page3LOAD, page4LOAD, ColumnWidth, blankDiv, SVGandTEXT, pageClear} from '../modules/main.mjs';
...
if (window.location.href.includes('pagetwo')) {
  mainPage.style.left = `calc(${ColumnWidth * 2}vw`;
}
