import {transitionTime, page1LOAD, page2LOAD, page4LOAD, mainPage, ColumnWidth, blankDiv, SVGandTEXT, pageClear} from '../modules/main.mjs';
...
if (window.location.href.includes('pagethree')) {
